          ...
          <form action="/action_page.php" method="get">
              UserName: <input type="text" name="fname"><br>
                  Password: <input type="text" name="lname"><br><br>
                      <button type="button" onclick="location.href = 'http://njitactivities.com/index.php?page=accounts&action=register';"  class="btn btn-default" class="center">Login</button><br><br>
                      <button type="button" onclick="location.href = 'http://njitactivities.com/index.php?page=accounts&action=edit';" class="btn btn-default" class="center">OR Create a new account</button>
                      </form>
        </div>
        <!-- /.col-lg-3 -->
